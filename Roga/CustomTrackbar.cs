...
namespace Roga
{
    ...
    {
        public Label currentValue = new Label();
        #region Events
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomTrackbar"/> class.
        /// </summary>
        /// <param name="min">The minimum value.</param>
        /// <param name="max">The maximum value.</param>
        /// <param name="value">The current value.</param>
        public CustomTrackbar(int min, int max, int value)
        {
        ...
        /// Initializes a new instance of the <see cref="CustomTrackbar"/> class.
        /// </summary>
        public CustomTrackbar() : this(0, 100, 50) { }
                                     ...
                                     Color barPenColorPaint, Color elapsedOuterColorPaint, Color elapsedInnerColorPaint)
        {
            try
            {
                ...
                if (barOrientation == Orientation.Horizontal)
                {
                    barRect.Inflate(-1, -barRect.Height / 40);
                    barHalfRect = barRect;
